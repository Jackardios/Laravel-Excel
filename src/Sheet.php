    ...
    public function import($import, int $startRow = 1)
    {
        ...
        if ($import instanceof OnEachRow) {
            ...
            foreach ($this->worksheet->getRowIterator()->resetStart($startRow ?? 1) as $row) {
                ...
                $rowArray = $sheetRow->toArray(null, $calculatesFormulas, $formatData, $endColumn);
                ...
                if (!$import instanceof SkipsEmptyRows || (!$rowIsEmptyAccordingToImport && !$sheetRow->isEmpty($calculatesFormulas, $formatData, $endColumn))) {
                    if ($import instanceof WithValidation) {
